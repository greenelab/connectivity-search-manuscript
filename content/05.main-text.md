...
which are also available as HetMat archives, consisting of `.tsv.gz` files, from Zenodo by metapath length [@doi:10.5281/zenodo.1435834].
...
However, the compute required to generate null DWPCs is more demanding, because there are multiple permuted hetnets (in our case 200).
As a result, computing and saving all DWPCs took 6 hours,
whearas computing and saving the null DWPC summary statistics took 361 hours.
