...
Explaning how two nodes are related is a non-trivial task as approaches are required to output more than a similarity score.
One solution towards solving this problem is to rank paths that are most relavant to two nodes [@doi:10.1007/978-3-319-25007-6_36; @doi:10.1145/3289600.3290990]. 
For example, Ghazimatin et al. [@doi:10.1145/3289600.3290990], constructed a tool that provides explanations for why items appear on a user's social media feed.
This tool uses a user interaction graph and generates a number of features such as node types, path similarity scores and metapath count to be used as input for a learn to rank model [@doi:10.1561/1500000016].
This model predicts the probability of a path being ranked higher than another path, so once the model converges the most relavant explanation path will be ranked as number one [@doi:10.1145/3289600.3290990].
Similar studies used the learn to rank model to generate explanations for how to nodes are related [@doi:10.1145/3132847.3133161; @doi:10.1145/3289600.3290990; @doi:10.1007/978-3-319-25007-6_36].
The other way to provide an explanation on why two nodes are related is to identify important subgraphs [@doi:10.1145/3184558.3186978; @doi10.1145/2983323.2983778].
These approaches have mainly been used on social media networks and have yet to enter the biomedical domain.
