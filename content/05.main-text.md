...
As part of this research, we developed the `xswap` Python [package](https://github.com/greenelab/xswap) with an optimized C/C++ implementation for network permutation [@xswap].
