...
While writing this application, we also elected to re-write the existing [rephetio](https://het.io/repurpose/) and [disease-associated genes](https://het.io/disease-genes/) apps in the same manner.
