...
We bundled the path count and DWPC matrix files into HetMat archives by metapath length and deposited the archives to Zenodo [@doi:zenodo].
...
For example, in [greenelab/hetmech#156](https://github.com/greenelab/hetmech/pull/156) \@zietzm proposes a notebook to visualize parameters for null DWPC distributions.
After \@zietzm addressed \@dhimmel's comments, the pull request was approved and merged into the project's main branch.

The manuscript for this study was written using Manubot, which allows authors to collaboratively write manuscripts on GitHub [@doi:10.1371/journal.pcbi.1007128].
