...
Each row shows a different metric computed for the _CbGpPWpG_ metapath --- traversing Compound--binds--Gene--participates--Pathway--participates--Gene, selected for illustrative purposes.
...
The rows display the following metrics of the DWPC distributions for all node-pairs in a given degree-group:
