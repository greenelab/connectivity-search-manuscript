...
](https://github.com/greenelab/connectivity-search-manuscript/raw/b290b4ad435553c7126867e0720f3112b4692809/content/media/website/website-homepage.png){#fig:website ) and other miscellaneous logos and iconography across the websiteidth="100%" .white}
...
The palette is used in all Hetio-related applications and materials.
...
For example, the colors used in the metagraph in Figure {@fig:rephetio}A are exactly the same colors, and thus represent the same types of entities, as in _any part of the connectivity search app_ ({@fig:webapp}).

Colors in the palette are also used in the Hetio logo (seen in {@fig:website}) and other miscellaneous logos and iconography across the website, to establish an identifiable "brand" for Hetio organization as a whole.

### Webapp and Frontend

We developed the [connectivity search app](https://het.io/search), as well as the related [rephetio](https://het.io/repurpose/) and [disease-associated genes](https://het.io/disease-genes/) apps, as single-page, standalone applications using React and associated tools.
The source code for the connectivity search app is available in the [`connectivity-search-frontend`](https://github.com/greenelab/connectivity-search-frontend) repository, and the source code for the related apps are available in the [hetio GitHub organization](https://github.com/hetio).
...
6) intuitive pan/zoom view that works on desktop and mobile.
7) node and edge appearances that were completely customizable for alignment, text wrapping, color, outlines, fonts, arrowheads, curved and stacked coincident edges, etc.

<!-- write about challenges of integrating D3 with React? -->
