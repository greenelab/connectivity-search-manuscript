...
![
**Schema for the connectivity search backend relational database.**
<!--
Consider touching this graph_models image up. Usage at
...
-->
](https://github.com/greenelab/connectivity-search-backend/raw/a91b25a0342050089c32ad2673e6a9c2f7ecad3f/media/models-schema.png){#fig:database width="5in"}
...
Producing results for these quieries relies on internal calls to both the PostgreSQL relational database as well as the pre-existing Hetionet v1.0 Neo4j graph database.
They were designed to power the hetnet connecitivy search webapp,
