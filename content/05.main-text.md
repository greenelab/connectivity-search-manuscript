...
](https://github.com/greenelab/connectivity-search-manuscript/raw/f98c3470a8bf8f40f5f6aed2794c6ea66b93b14b/content/media/rephetio/metagraph-and-features.png){#fig:rephetio width="100%" .white} <!-- pretty sure a previous paper at gigascience required us to move figures to the results section, so we may need to add a results panel and put this at the beginning of the results section.>

Project Rephetio was successfully predict treatments,
