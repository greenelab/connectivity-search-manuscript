...
We'd like to thank the two reviewers for their careful and insightful examination of our study.
In addition to revising the manuscript, we've responded to the points raised with additional detail here.
We are pleased that _GigaScience_ publishes reviews and responses alongside the article,
such that readers can benefit from this conversation.
This response to reviewers is [also online](https://github.com/greenelab/connectivity-search-manuscript/blob/main/content/response-to-reviewers.md) as part of the Manubot manuscript repository for this study.
